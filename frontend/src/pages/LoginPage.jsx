    ...
    <main className="flex min-h-screen items-center justify-center bg-slate-50 p-4">
      <section className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-6 space-y-3 text-center">
          <p className="text-sm text-slate-600">Don't have an account yet?</p>
          <Link
            to="/signup"
            className="inline-flex w-full justify-center rounded-lg border border-sky-600 bg-white px-3 py-2 text-sm font-medium text-sky-600 transition-colors hover:bg-sky-50"
          >
            Create account
          </Link>
        </div>
